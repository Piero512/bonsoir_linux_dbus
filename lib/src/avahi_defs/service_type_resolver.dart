...
class AvahiServiceTypeBrowser extends DBusRemoteObject {
  AvahiServiceTypeBrowser(DBusClient client, String destination,
  ...
  Stream<AvahiServiceTypeBrowserItemNew> subscribeItemNew() async* {
    ...
    await for (var signal in signals) {
      if (signal.values.length == 5 &&
          ...
          signal.values[4].signature == DBusSignature('u')) {
  ...
  Stream<AvahiServiceTypeBrowserCacheExhausted>
