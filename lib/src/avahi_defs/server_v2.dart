...
class AvahiServerV2StateChanged extends DBusSignal{
  ...
  AvahiServerV2StateChanged(DBusSignal signal) : super(signal.sender, signal.path, signal.interface, signal.member, signal.values);
}

class AvahiServerV2 extends DBusRemoteObject {
  AvahiServerV2(DBusClient client, String destination, DBusObjectPath path) : super(client, destination, path);
